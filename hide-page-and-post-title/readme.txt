...
Tags: hide page title, hide post title, hide title, hide custom post title
...
Hide titles on individual pages, posts and public custom post types.
...
1. Activate the Hide Page And Post Title plugin from the WordPress Plugins screen.
2. Enable "Hide the title" when editing a page or post.
...
Includes minor documentation and plugin listing improvements.

= 1.6.1 =

Improves WordPress compatibility, output escaping, and code standards. The minimum supported WordPress version is now 4.1.

= 1.6.0 =

Adds support for WordPress block themes and improves compatibility with classic themes.

== Changelog ==

= 1.6.2 =
* Updated plugin documentation and FAQs.
* Added screenshots to the plugin documentation.
* Improved plugin listing information and search relevance.

= 1.6.1 =
* Improved security and protection against direct access.
* Improved output escaping and validation.
* Raised the minimum supported WordPress version to 4.1 to support current WordPress functionality and security standards.
* Improved compatibility with current WordPress standards.
